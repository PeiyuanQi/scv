...
```json
{"type":"initialize","request_id":"1","protocol_version":2,"client":{"name":"scv-tui","version":"0.1.14"}}
```
...
```json
{"type":"initialized","request_id":"1","protocol_version":2,"server":{"name":"scv-server","version":"0.1.14"}}
...
```json
{"type":"daemon.status","request_id":"d1","status":{"version":"0.1.14","pid":1234,"components":[{"id":"clawbot:default","account":"default","bot_id":"bot-example","user_id":"user-example","enabled":true,"state":"connected","last_success_unix_seconds":1750000000,"error":null,"restarts":0}]}}
```
